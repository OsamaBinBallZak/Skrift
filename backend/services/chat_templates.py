...
# Qwen3 / Qwen3.5 chat template with thinking mode disabled.
# Source: official Qwen3 template with enable_thinking = false.
_QWEN3_TEMPLATE = """{%- set enable_thinking = false %}
