...
DEFAULT_SETTINGS = {
    ...
    "enhancement": {
        ...
        "prompts": {
            ...
            "vision_copy_edit": "Clean up this voice memo segment. You can see the photo the speaker took at this moment.\n\nRules:\n1. Fix grammar and remove filler words. Keep the speaker's casual voice.\n2. You MUST add one short detail from the photo, woven into the text as a natural clause.\n   Example: \"the wall came off, exposing yellow plaster and white tiles beneath\"\n   NOT: \"[The wall shows yellow plaster]\"\n3. Do not read text in the photo. Do not include [[img_XXX]] markers.\n4. Preserve [[double bracket links]].\n\nOutput only the enhanced text."
        },
