...
export const DEFAULT_PROMPTS: EnhancePrompt[] = [
  { id: 'title', label: 'Generate Title', tag: 'title', tagColor: '#7c6bf5', desc: 'Extract or generate a title', instruction: 'Analyze the transcript. If a clear title is mentioned, extract it. Otherwise generate a short, descriptive title. Return only the title text, nothing else.' },
  { id: 'copyedit', label: 'Copy Edit', tag: 'copy-edit', tagColor: '#6366f1', desc: 'Fix spelling, grammar, readability', instruction: 'Rewrite to fix spelling, grammar, and readability. Preserve all [[wikilinks]]. Output only the corrected text, nothing else.' },
  { id: 'summary', label: 'Summary', tag: 'summary', tagColor: '#a855f7', desc: '1–2 sentence summary matching tone', instruction: 'Summarize in 1–2 sentences. Match the original tone. Write as a direct note, not a description of one.' },
]
